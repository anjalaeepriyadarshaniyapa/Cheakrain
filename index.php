...
<body style="background-color:#F4F4F4; position:relative; top:5%">
  ...
  <div class="container1">
    ...
    <div class="title">
      <h2 style="text-align: center; color:Teal;"> Silze</h2>
                  ...
                  <div class="bg-light p-3" style="border-radius:10px;">
                    ...
                    <div class="row">
                      <div class="col-12 text-center">
                        <h3>Your Device is Not compatible to run Checkrain check alternative solution</h3>
                      </div>
                    </div>
                  ...
                  $("#div-result").append(`
                    <div class="bg-light p-3 mt-1" style="border-radius:10px;">
                      ...
                      <div class="row" style="margin-bottom: 15px;">
                        <div class="col-12 text-center">
                          <h4 style="color:MediumSeaGreen;" > Good news-Checkrain Supports your Device and iOS/iPadOS</h4>
                        </div>
                      </div>
                      <div class="row" style="margin-bottom: 15px;">
                        <div class="col-12 text-center">
